...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NameModel', function() {
      ...
      it('should have the property dnQualifier (base name: "dnQualifier")', function() {
        // TODO: update the code to test the property dnQualifier
        expect(instance).to.have.property('dnQualifier');
        // expect(instance.dnQualifier).to.be(expectedValueLiteral);
      });

      it('should have the property stateName (base name: "stateName")', function() {
        // TODO: update the code to test the property stateName
        expect(instance).to.have.property('stateName');
        // expect(instance.stateName).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property pseudonym (base name: "pseudonym")', function() {
        // TODO: update the code to test the property pseudonym
        expect(instance).to.have.property('pseudonym');
        // expect(instance.pseudonym).to.be(expectedValueLiteral);
      });

      it('should have the property generationQualifier (base name: "generationQualifier")', function() {
        // TODO: update the code to test the property generationQualifier
        expect(instance).to.have.property('generationQualifier');
        // expect(instance.generationQualifier).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property allValues (base name: "allValues")', function() {
        // TODO: update the code to test the property allValues
        expect(instance).to.have.property('allValues');
        // expect(instance.allValues).to.be(expectedValueLiteral);
      });
