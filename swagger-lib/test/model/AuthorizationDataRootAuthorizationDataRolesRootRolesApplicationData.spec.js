...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthorizationDataRootAuthorizationDataRolesRootRolesApplicationData', function() {
      ...
      it('should have the property authorizationData (base name: "authorizationData")', function() {
        // TODO: update the code to test the property authorizationData
        expect(instance).to.have.property('authorizationData');
        // expect(instance.authorizationData).to.be(expectedValueLiteral);
      });

      it('should have the property rootAuthorizationData (base name: "rootAuthorizationData")', function() {
        // TODO: update the code to test the property rootAuthorizationData
        expect(instance).to.have.property('rootAuthorizationData');
        // expect(instance.rootAuthorizationData).to.be(expectedValueLiteral);
      });
