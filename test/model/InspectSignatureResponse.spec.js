...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InspectSignatureResponse', function() {
      beforeEach(function() {
        instance = new RestPkiCoreClient.InspectSignatureResponse();
      });

      it('should create an instance of InspectSignatureResponse', function() {
        // TODO: update the code to test InspectSignatureResponse
        expect(instance).to.be.a(RestPkiCoreClient.InspectSignatureResponse);
      });
