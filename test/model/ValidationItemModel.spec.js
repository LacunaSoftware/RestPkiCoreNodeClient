...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ValidationItemModel', function() {
      ...
      it('should have the property innerValidationResults (base name: "innerValidationResults")', function() {
        // TODO: update the code to test the property innerValidationResults
        expect(instance).to.have.property('innerValidationResults');
        // expect(instance.innerValidationResults).to.be(expectedValueLiteral);
      });
