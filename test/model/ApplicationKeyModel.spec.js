...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApplicationKeyModel', function() {
      beforeEach(function() {
        instance = new RestPkiCoreClient.ApplicationKeyModel();
      });

      it('should create an instance of ApplicationKeyModel', function() {
        // TODO: update the code to test ApplicationKeyModel
        expect(instance).to.be.a(RestPkiCoreClient.ApplicationKeyModel);
      });
      ...
      it('should have the property certificateThumbprint (base name: "certificateThumbprint")', function() {
        // TODO: update the code to test the property certificateThumbprint
        expect(instance).to.have.property('certificateThumbprint');
        // expect(instance.certificateThumbprint).to.be(expectedValueLiteral);
      });
