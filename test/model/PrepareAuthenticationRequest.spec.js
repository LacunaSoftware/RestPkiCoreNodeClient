...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrepareAuthenticationRequest', function() {
      ...
      it('should have the property ignoreRevocationStatusUnknown (base name: "ignoreRevocationStatusUnknown")', function() {
        // TODO: update the code to test the property ignoreRevocationStatusUnknown
        expect(instance).to.have.property('ignoreRevocationStatusUnknown');
        // expect(instance.ignoreRevocationStatusUnknown).to.be(expectedValueLiteral);
      });
