...
export class PadesVisualRepresentationModel {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "position",
            "baseName": "position",
            "type": "PadesVisualPositioningModel"
        },
        {
            "name": "text",
            "baseName": "text",
            "type": "PadesVisualTextModel"
        },
        {
            "name": "image",
            "baseName": "image",
            "type": "PadesVisualImageModel"
        }    ];

    static getAttributeTypeMap() {
        return PadesVisualRepresentationModel.attributeTypeMap;
    }
}
