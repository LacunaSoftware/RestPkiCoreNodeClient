...
export class SignerModel {
    ...
    'certifiedDateReference'?: Date | null;
    'timestamps'?: Array<CadesTimestampModel> | null;
    'isDocumentTimestamp'?: boolean;
    'signatureFieldName'?: string | null;
    'validationResults'?: ValidationResultsModel;
    'hasLtv'?: boolean | null;
    'xmlSignedEntityType'?: XmlSignedEntityTypes;
    'xmlSignedElement'?: XmlElementModel;
    'attributeCertificates'?: Array<AttributeCertificateModel> | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "messageDigest",
            "baseName": "messageDigest",
            "type": "DigestAlgorithmAndValueModel"
        },
        {
            "name": "signature",
            "baseName": "signature",
            "type": "SignatureAlgorithmAndValueModel"
        },
        {
            "name": "signaturePolicy",
            "baseName": "signaturePolicy",
            "type": "SignaturePolicyIdentifierModel"
        },
        {
            "name": "signingTime",
            "baseName": "signingTime",
            "type": "Date"
        },
        {
            "name": "certifiedDateReference",
            "baseName": "certifiedDateReference",
            "type": "Date"
        },
        {
            "name": "timestamps",
            "baseName": "timestamps",
            "type": "Array<CadesTimestampModel>"
        },
        {
            "name": "isDocumentTimestamp",
            "baseName": "isDocumentTimestamp",
            "type": "boolean"
        },
        {
            "name": "signatureFieldName",
            "baseName": "signatureFieldName",
            "type": "string"
        },
        {
        ...
        {
            "name": "xmlSignedEntityType",
            "baseName": "xmlSignedEntityType",
            "type": "XmlSignedEntityTypes"
        },
        {
            "name": "xmlSignedElement",
            "baseName": "xmlSignedElement",
            "type": "XmlElementModel"
        },
        {
            "name": "attributeCertificates",
            "baseName": "attributeCertificates",
            "type": "Array<AttributeCertificateModel>"
        },
        {
            "name": "certificate",
    ...
    static getAttributeTypeMap() {
        return SignerModel.attributeTypeMap;
    }
}

export namespace SignerModel {
}
