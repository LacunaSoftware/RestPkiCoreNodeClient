...
export class PadesSignerModel {
    ...
    'commitmentType'?: CommitmentTypeModel;
    'bStamp'?: SignerBStampModel;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CommitmentTypeModel"
        },
        {
            "name": "bStamp",
            "baseName": "bStamp",
            "type": "SignerBStampModel"
        }    ];

    static getAttributeTypeMap() {
        return PadesSignerModel.attributeTypeMap;
    }
}
