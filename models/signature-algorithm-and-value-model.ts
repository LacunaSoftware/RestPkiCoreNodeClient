 ...
 */
import { SignatureAlgorithmIdentifier } from './signature-algorithm-identifier';
/**
 * 
 * @export
 * @interface SignatureAlgorithmAndValueModel
 */
export interface SignatureAlgorithmAndValueModel {
    /**
     * 
     * @type {SignatureAlgorithmIdentifier}
     * @memberof SignatureAlgorithmAndValueModel
     */
