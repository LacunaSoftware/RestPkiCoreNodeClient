 ...
 */
import { AuthenticationFailures } from './authentication-failures';
import { CertificateModel } from './certificate-model';
import { ValidationResultsModel } from './validation-results-model';
/**
 * 
 * @export
 * @interface CompleteAuthenticationResponse
 */
export interface CompleteAuthenticationResponse {
    /**
     * 
     * @type {boolean}
     * @memberof CompleteAuthenticationResponse
     */
    success?: boolean;
    /**
     * 
     ...
     * @memberof CompleteAuthenticationResponse
     */
    failure?: AuthenticationFailures;
    /**
     * 
